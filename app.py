...
github_icon_svg = '''
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" style="width: 2em; height: 2em; color: white;">
...
'''
linkedin_icon_svg = '''
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="width: 2em; height: 2em; color: white;">
<path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/></svg>
'''
email_icon_svg = '''
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 2em; height: 2em; color: white;">
...
with st.container():
    ...
    with text_column:
        st.subheader("CREDIT DEFAULT MODEL")

    with text_column:
        col1, col2, col3, col4 = st.columns((2, 2, 2, 15))
        with col1:
            display_icon_link(github_icon_svg, github_link)
            st.markdown('<div class="github-icon"></div>', unsafe_allow_html=True)

        with col2:
            display_icon_link(linkedin_icon_svg, linkedin_link)
            st.markdown('<div class="linkedin-icon"></div>', unsafe_allow_html=True)

        with col3:
            display_icon_link(email_icon_svg, email_link)
            st.markdown('<div class="email-icon"></div>', unsafe_allow_html=True)
        with col4:
            pass
